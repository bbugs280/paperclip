  ...
  instanceConfigSchema: {
    ...
    properties: {
      bearerTokenRef: {
        ...
        description: "Secret reference for X API bearer token (read-only mode)",
        default: "x_bearer_token",
      },
      accessTokenRef: {
        type: "string",
        title: "Access Token Reference",
        description: "Secret reference for X API user access token (for write operations)",
        default: "x_access_token",
      },
      accessTokenSecretRef: {
        type: "string",
        title: "Access Token Secret Reference",
        description: "Secret reference for X API access token secret for OAuth 1.0a",
